...
"[project]/app/api/appointments/approve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // Validate input
        const validatedData = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2f$appointment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appointmentApprovalSchema"].parse(body);
        ...
        const updatedAppointment = await prisma.appointment.update({
            ...
            data: {
                status: __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["AppointmentStatus"].APPROVED,
        ...
        if (JSON.stringify(validatedData.service_ids.sort()) !== JSON.stringify(appointment.appointment_services.map((as)=>as.service_id).sort())) {
            // Delete old services
...
//# sourceMappingURL=%5Broot-of-the-server%5D__57523c16._.js.map